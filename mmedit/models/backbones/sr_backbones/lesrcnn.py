...
class LESRCNN(nn.Module):
    def __init__(self,
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=channels, out_channels=features,
                      kernel_size=kernel_size, padding=padding, groups=1,
                      bias=False))
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=features, out_channels=features,
                      kernel_size=kernel_size, padding=1, groups=1,
                      bias=False), nn.ReLU(inplace=True))
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=features, out_channels=features,
                      kernel_size=kernel_size1, padding=0, groups=groups,
                      bias=False))
        ...
        self.conv18 = nn.Sequential(
            nn.Conv2d(in_channels=features, out_channels=3,
        ...
        '''
        self.ReLU = nn.ReLU(inplace=True)
        self.upsample = UpsampleBlock(64, scale=self.upscale_factor,
                                      multi_scale=multi_scale, group=1)
    ...
    def forward(self, x):
        ...
        temp = self.upsample(x17_3, scale=self.upscale_factor)
        x1111 = self.upsample(x1_1, scale=self.upscale_factor)  # tcw
